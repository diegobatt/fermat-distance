...
test_that("For sufficiently large alpha, distance KNN method equals full", {
  alpha <- 6
  knn_fd <- fermat_dist(X, "knn", alpha = alpha)
  fd <- fermat_dist(X, "full", alpha = alpha)
